...
<body>
	...
	<div id="admin">
		...
		<div id="admin_perform">
			<ul>
				<li><a href="update_painter.php">update painetr information</a></li>
				<li class="current_update"><a href="update_painting.php">update painting information</a></li>
			</ul>
		</div>
	...
	<div id="update">
		<div id="update_box">
			...
			<form class="update_form" action="update_painter_action.php" method="post">
				<ul class="painting_info">
					<li>Painting Name (CN) <input type="text" name="painterCN" placeholder="e.g. 山鬼" required></li>
					<li>Painting Name (pinyin) <input type="text" name="painterEN" placeholder="e.g. Shan Gui" required></li>
					...
					<li>Painting URL <input type="text" name="portraitURL" class="input_text" required></li>
				</ul>
				<div class="button">
